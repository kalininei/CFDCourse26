...
const Quadrature* cfd::quadrature_triangle_gauss1() {
    static Quadrature quad({Point(1.0 / 3.0, 1.0 / 3.0)}, {0.5});
...
const Quadrature* cfd::quadrature_triangle_gauss4() {
    static Quadrature quad({Point(0.44594849091597, 0.44594849091597), Point(0.44594849091597, 0.10810301816807),
                            Point(0.10810301816807, 0.44594849091597), Point(0.09157621350977, 0.09157621350977),
                            Point(0.09157621350977, 0.81684757298046), Point(0.81684757298046, 0.09157621350977)},
                           {0.22338158967801 / 2.0, 0.22338158967801 / 2.0, 0.22338158967801 / 2.0,
...
const Quadrature* cfd::quadrature_triangle_gauss5() {
    static Quadrature quad({Point(0.33333333333333, 0.33333333333333), Point(0.47014206410511, 0.47014206410511),
                            Point(0.47014206410511, 0.05971587178977), Point(0.05971587178977, 0.47014206410511),
                            Point(0.10128650732346, 0.10128650732346), Point(0.10128650732346, 0.79742698535309),
                            Point(0.79742698535309, 0.10128650732346)},
                           {0.22500000000000 / 2, 0.13239415278851 / 2, 0.13239415278851 / 2, 0.13239415278851 / 2,
...
const Quadrature* cfd::quadrature_triangle_gauss6() {
    static Quadrature quad(
        ...
        {0.11678627572638 / 2, 0.11678627572638 / 2, 0.11678627572638 / 2, 0.05084490637021 / 2, 0.05084490637021 / 2,
         0.05084490637021 / 2, 0.08285107561837 / 2, 0.08285107561837 / 2, 0.08285107561837 / 2, 0.08285107561837 / 2,
         0.08285107561837 / 2, 0.08285107561837 / 2});
    return &quad;
}
