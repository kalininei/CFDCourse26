...
\item Учесть силы межфазного взаимодействия $\vec M_k$. Применить модель Шилера-Неймана (\secref{sec:schiller-naumann}) выбрав малый радиус капель дисперсной фазы (например $d_1 = 10^{-3}$). Сравнить полученный график $E_p(t)$ с исходным.
...
\item п.4 Учитывать сопротивление в уравнениях для $\vec u^*_k$ следует также явно, беря скорость с предыдущей итерации.
