...
\end{equation}
Задача выразить $r_{ij}$ через $r^*_{ijk} \geq 0$
\begin{equation}
...
Найдём элемент $E_a$, ближайший к фиктивной точке $\vec x^*$.
...
независимо от того, содержит он узел $i$ или нет. Тогда аналогично
\begin{equation}
